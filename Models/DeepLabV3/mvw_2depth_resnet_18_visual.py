...
experiment.set_name('MVW-2Depth-ResNet-18-Visual')
...
class MultiviewNet(torch.nn.Module):
    def __init__(self, name_second_network):
        ...
        self.modelo = smp.DeepLabV3Plus(encoder_name = 'resnet18', encoder_weights = 'imagenet', in_channels=36, classes=2)
...
def entrena(red):
    ...
    torch.save(mejor_modelo, 'mejor_modelo_MVW-2Depth-ResNet-18-Visual')
    torch.save(red, 'ultimo_modelo_MVW-2Depth-ResNet-18-Visual')
