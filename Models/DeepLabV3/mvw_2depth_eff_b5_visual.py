...
experiment = Experiment(
    ...
    project_name="deep-lab-paper-msc",
    workspace="jesusfernandeziglesias",
)
experiment.set_name('MVW-2Depth-Eff-b5-Visual')
...
class MultiviewNet(torch.nn.Module):
    def __init__(self, name_second_network):
        ...
        self.modelo = smp.DeepLabV3Plus(encoder_name = 'timm-efficientnet-b5', encoder_weights = 'noisy-student', in_channels=36, classes=2)
...
def entrena(red):
    ...
    torch.save(mejor_modelo, 'mejor_modelo_MVW-2Depth-Eff-b5-Visual')
    torch.save(red, 'ultimo_modelo_MVW-2Depth-Eff-b5-Visual')
...
experiment.log_notebook('MVW-2Depth-Eff-b4-Visual.py')
experiment.end()
