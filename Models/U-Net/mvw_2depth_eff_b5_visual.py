...
class MultiviewNet(torch.nn.Module):
    def __init__(self, name_second_network):
        ...
        self.modelo = smp.Unet(encoder_name = 'timm-efficientnet-b5', encoder_weights = 'noisy-student', in_channels=36, classes=2)
...
#experiment.log_notebook('MVW-2Depth-Eff-b5-Visual.py')
#experiment.end()
