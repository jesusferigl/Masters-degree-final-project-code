...
experiment.set_name('MVW-2Depth-ResNet-50-Base')
...
class MultiviewNet(torch.nn.Module):
    def __init__(self, name_second_network):
        ...
        self.modelo.encoder.conv1 = torch.nn.Conv2d(9, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
...
def entrena(red):
    ...
    torch.save(mejor_modelo, 'mejor_modelo_MVW-2Depth-ResNet-50-Base')
    torch.save(red, 'ultimo_modelo_MVW-2Depth-ResNet-50-Base')
