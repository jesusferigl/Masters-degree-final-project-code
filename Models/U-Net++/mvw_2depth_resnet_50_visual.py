...
experiment.set_name('MVW-2Depth-ResNet-50-Visual')
...
class MultiviewNet(torch.nn.Module):
    def __init__(self, name_second_network):
        ...
        self.modelo = smp.UnetPlusPlus(name_second_network)
        self.modelo.encoder.conv1 = torch.nn.Conv2d(36, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
        self.modelo.segmentation_head[0] = torch.nn.Conv2d(16, 2, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
...
def entrena(red):
    ...
    torch.save(mejor_modelo, 'mejor_modelo_MVW-2Depth-ResNet-50-Visual')
    torch.save(red, 'ultimo_modelo_MVW-2Depth-ResNet-50-Visual')
...
experiment.log_notebook('MVW-2Depth-ResNet-50-Visual.py')
experiment.end()
